  ...
  "node_modules/react-diff-viewer-continued/lib/src/index.js"(exports) {
    ...
    var DiffViewer = class extends React.Component {
      constructor(props) {
        ...
        this.computeStyles = memoize2(styles_1.default);
        ...
        this.renderLine = (lineNumber, type, prefix3, value, additionalLineNumber, additionalPrefix) => {
        ...
        this.renderDiff = () => {
          ...
          return lineInformation.map((line2, lineIndex) => {
            if (this.props.showDiffOnly) {
              ...
              if (blockIndex !== void 0) {
                ...
                if (!this.state.expandedBlocks.includes(blockIndex) && lastLineOfBlock) {
                  return (0, jsx_runtime_1.jsx)(React.Fragment, { children: this.renderSkippedLineIndicator(blocks[blockIndex].lines, blockIndex, line2.left.lineNumber, line2.right.lineNumber) }, lineIndex);
                } else if (!this.state.expandedBlocks.includes(blockIndex)) {
                  return null;
                }
              }
            }
            const diffNodes = splitView ? this.renderSplitView(line2, lineIndex) : this.renderInlineView(line2, lineIndex);
            return diffNodes;
          });
        };
        this.render = () => {
